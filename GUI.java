...
public abstract class GUI {
	...
	protected boolean displayAP; //Graph uses this to draw articulation points or not
	...
	private void initialise() {
		...
		JButton toggleAP = new JButton("Toggle AP");
		toggleAP.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				displayAP = !displayAP;
				redraw();
			}
		...
		JButton distanceTime = new JButton("Distance");
		distanceTime.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				distanceTime.setText(distanceTime.getText().equals("Distance")? "Time" : "Distance");
		...
		extras.setMaximumSize(new Dimension(50, 100));
		
		extras.add(toggleAP);
		extras.add(distanceTime);
		controls.add(extras);
